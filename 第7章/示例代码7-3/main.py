...
class Window(QGraphicsView):
    def __init__(self):
        ...
        self.rect2.setParentItem(self.rect1)		# 1
        self.rect2.setZValue(1.0)				    # 2
        ...
        self.rect3.setParentItem(self.rect1)        # 1
        ...
        self.graphics_scene.addItem(self.rect1)		# 3
